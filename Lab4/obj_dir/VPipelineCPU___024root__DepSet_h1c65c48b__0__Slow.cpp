...
VL_ATTR_COLD void VPipelineCPU___024root___eval_initial__TOP(VPipelineCPU___024root* vlSelf) {
    ...
    // Body
    vlSelf->PipelineCPU__DOT__PC_out_IF = 0U;
...
VL_ATTR_COLD void VPipelineCPU___024root___dump_triggers__act(VPipelineCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(3U)) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @([changed] PipelineCPU.ALUOut_MEM or [changed] PipelineCPU.memRead_MEM)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VPipelineCPU___024root___dump_triggers__nba(VPipelineCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(3U)) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @([changed] PipelineCPU.ALUOut_MEM or [changed] PipelineCPU.memRead_MEM)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VPipelineCPU___024root___ctor_var_reset(VPipelineCPU___024root* vlSelf) {
    ...
    vlSelf->PipelineCPU__DOT__PC_counter = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_out_IF = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_out_ID = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_plus4_ID = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__IMEM_out_ID = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__IMMGEN_out_ID = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__readData1_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__readData2_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__IMMGEN_out_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_plus4_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__IMEM_out_EX = VL_RAND_RESET_I(32);
    ...
    vlSelf->PipelineCPU__DOT__IMEM_out_MEM = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__DMEM_out_MEM = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_plus4_WB = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ALUOut_WB = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__DMEM_out_WB = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__IMEM_out_WB = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vdly__PipelineCPU__DOT__PC_out_IF = VL_RAND_RESET_I(32);
